"""Diagnóstico rápido de la sesión de DistroKid (no descarga nada)."""
import sys
...
print("cookie len:", len(headers["cookie"]))
...
urls = [
    ...
    "https://distrokid.com/dashboard/album/?albumuuid=3106381A-EB94-420B-91EDFEF4DEF34A3E",
]
    ...
    for url in urls:
        try:
            ...
            if "<title>" in body:
                ...
                title = body[start:end][:60]
            print(f"{resp.status_code} {url}")
            print(f"   len={len(body)} title={title!r}")
